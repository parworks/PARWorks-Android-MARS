...
####Compiling
To compile the PARWorks MARS application, check out the git repository and then pull in submodules. 

You will need:

The PARWorks Android SDK: https://github.com/parworks/PARWorks-Android-Java
The PARWorks Android external libs: https://github.com/parworks/PARWorks-Android-External-Libs

...
public class IntroLastPageFragment extends Fragment {
	 ...
	 * given page number.
	 */
	public static IntroLastPageFragment create(int pageNumber, int resId) {
		IntroLastPageFragment fragment = new IntroLastPageFragment(resId);
	...
	public IntroLastPageFragment() {
	}

	public IntroLastPageFragment(int resId) {
		mResId = resId;
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		User.setHasPerformedFirstLaunch(true, mContext);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ViewGroup rootView = (ViewGroup) inflater.inflate(
				R.layout.fragment_intro_last_page, container, false);

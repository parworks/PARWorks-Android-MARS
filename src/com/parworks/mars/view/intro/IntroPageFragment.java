...
public class IntroPageFragment extends Fragment {
	 ...
	 * given page number.
	 */
	public static IntroPageFragment create(int pageNumber, int resId) {
		IntroPageFragment fragment = new IntroPageFragment(resId);
	...
	public IntroPageFragment(int resId) {
		mResId = resId;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_intro_page,
				container, false);
